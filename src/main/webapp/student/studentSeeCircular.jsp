...
<% 
  ...
  <div id="content"  style= " background: linear-gradient(rgb(169 ,148 ,166, 75%),rgb(90 ,87, 122 , 75%)),url('../images/new.webp')!important;  background-size: cover!important;"> <h1 class="head">Circulars</h1>
