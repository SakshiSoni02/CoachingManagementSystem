...
<div id="content" style= " background: linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url('../images/bg_newww3.avif')!important;  background-size: cover!important;">
    <h1>Registered students waiting list..</h1>
        ...
        <table>
            ...
            <c:forEach items="${list1}" var="u">  
                <tr>
                    ...
                    <td>${u.getFees()}</td>
                    <td class="btncolor">
                        <a class="btn btn-success" href='../approvestudent?pid=${u.getId()}'>Approve</a>
                        <a class="btn btn-danger" href='../deleteregistered?pid=${u.getId()}'>Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
